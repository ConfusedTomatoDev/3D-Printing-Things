...
2. Place all timelapse images into separated isolated folders under the main working folder.
3. Place the batch file in the working folder.
4. Downloads and copy the contents of ffmpeg bin folder directly into the same working folder, or update the batch file to include the full path to ffmpeg.exe folder.
